...
SUPABASE_URL = "https://hnfscgitcelttdljypbo.supabase.co"
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhuZnNjZ2l0Y2VsdHRkbGp5cGJvIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3ODAyOTAzOCwiZXhwIjoyMDkzNjA1MDM4fQ.gvAriuXfFKbLJ-vWaYY-dV_IXTT5Gtoa7C33infun6A"
BUCKET_NAME = "media"
...
def upload_to_storage(path, file_bytes):
    try:
        # Uploading with webp content-type as per assignment requirements
        ...
        print(f"Skipping upload for {path} (might already exist or error: {e})")
